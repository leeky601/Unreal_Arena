...
void AArStoneBase::Consume(UArAbilitySystemComponent* AbilitySystemComponent, int32 ApplyLevel)
{
	check(StoneGameplayEffectClass);

	UGameplayEffect* StoneEffectCDO = StoneGameplayEffectClass->GetDefaultObject<UGameplayEffect>();
